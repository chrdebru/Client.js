...
function union(geom1, geom2) {
  ...
  if ((gA.type === 'Polygon' || gA.type === 'MultiPolygon') && (gB.type === 'Polygon' || gA.type === 'MultiPolygon')) {
...
function distance(geom1, geom2, units) {
  ...
  var distance = turf.distance(turf.center(featuredGeom1), turf.center(featuredGeom2), parsedUnit);
